...
let gameWording1 = numUnfunded === 1 ? 'game remains unfunded' : 'games remain unfunded';
let gameWording2 = numUnfunded === 1 ? 'this amazing game' : 'these amazing games';

const displayString = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for 
${totalGames.toLocaleString('en-US')} games. Currently, ${numUnfunded} ${gameWording1}. 
We need your help to fund ${gameWording2}.`;
